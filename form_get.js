...
http.createServer(function(req, res){
    ...
    if (q.pathname =="/search/" && req.method == "GET"){
        // ambil parameter dari keyword
        var keyword = q.query.keyword;

        if (keyword) {
            //ambil data dari form metode GET
            res.writeHead(200, {'Content-Type' : 'text/html'});
            res.write("<h3> Search result : </h3>");
            res.write("<p> Anda mencari : <b>" + keyword + "<b> </p>");
            res.write("<pre>Tidak ada hasil! Maaf website ini masih dalam tahap pengembangan</pre>");
